...
Gem::Specification.new do |s|
  ...
  s.authors = ["xdotcommer", "remi", "mhartl"]
  s.date = %q{2009-01-28}
  s.description = %q{Define RSpec custom matchers in 1 line}
  s.email = %q{remi@remitaylor.com mcowden@yahoo.com michael@michaelhartl.com}
  ...
  s.has_rdoc = true
  s.homepage = %q{http://github.com/mhartl/rspec-custom-matchers}
